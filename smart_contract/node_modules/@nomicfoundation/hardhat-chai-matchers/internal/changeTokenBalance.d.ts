...
export declare function getBalanceChange(transaction: TransactionResponse | Promise<TransactionResponse> | (() => TransactionResponse) | (() => Promise<TransactionResponse>), token: Token, account: Account | string): Promise<EthersT.ethers.BigNumber>;
